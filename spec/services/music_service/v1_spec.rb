...
RSpec.describe MusicService::V1 do
  ...
  describe '.songs' do
    ...
    before do
      allow(MusicService).to receive(:song_keys).and_return(['artic_monkeys/am/do_i_wanna_know?'])
  ...
  describe '.music' do
    ...
    before do
      allow(MusicService).to receive(:song_keys).and_return(['artist/album/song.mp3'])
